...
$options[] = array( "name" => "",
					"message" => __('Here you can configure some basics for your blog post pages.','framework'),
					"type" => "intro");
...
$options[] = array( "name" => __('Show Featured Image','framework'),
					...
					"id" => $shortname . "_display_featured_img",
					"std" => __('Yes', 'framework'),
					"type" => 'select',
					'options' => array(__('Yes', 'framework'), __('No', 'framework')));
					
$options[] = array( "name" => __('Comments Intro Copy','framework'),
					"desc" => __('Add a bit of copy to introduce your comments section.','framework'),
					"id" => $shortname . "_comments_intro",
					"std" => "",
					"type" => "textarea");
					
$options[] = array( "name" => __('Comment Form Intro Copy','framework'),
            		"desc" => __('Encourage comments and write the ground rules for playing nice.','framework'),
            		"id" => $shortname . "_comments_form_intro",
            		"std" => "",
            		"type" => "textarea");
...
$options[] = array( "name" => "",
					"message" => __('Here you can configure some basics for your portfolios pages.','framework'),
					"type" => "intro");

$options[] = array( "name" => __('Number of Related Portfolios to Display','framework'),
					"desc" => __('How many related posts should be displayed? If you don\'t want to show related posts leave this field blank or set to 0','framework'),
