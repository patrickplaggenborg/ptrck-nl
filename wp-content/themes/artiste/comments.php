...
/*-----------------------------------------------------------------------------------*/
		...
		<div class="comments_intro">
		    <h3 id="comments"><?php comments_number(__('0 Comments', 'framework'), __('1 Comment', 'framework'), __('% Comments', 'framework')); ?></h3>
		    <?php
		        $comments_intro = get_option('tz_comments_intro');
		        if( !empty($comments_intro) ) {
		            echo '<p>' . $comments_intro . '</p>';
		        }
	        ?>
            <a href="#respond"><?php _e('Leave a comment', 'framework'); ?></a>
		</div>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond">
        ...
        <div class="comments_intro">
		    ...
		    <?php 
		        $comments_form_intro = get_option('tz_comments_form_intro');
		        if( !empty($comments_form_intro) ) {
		            echo '<p>' . $comments_form_intro . '</p>';
		        }
		    ?>
		</div>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<label for="email"><small><?php _e('Email', 'framework') ?> <?php if ($req) _e("*", 'framework'); ?> <span><?php _e('(never published)', 'framework'); ?></span></small></label></p>
