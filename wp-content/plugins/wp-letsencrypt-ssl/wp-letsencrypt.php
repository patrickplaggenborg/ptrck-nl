 ...
 * Plugin URI:        https://gowebsmarty.com/product/wp-encryption-pro/
 * Description:       Secure your WordPress site with free SSL certificate from Let's Encrypt.
 * Version:           4.0.0
        ...
        function wple_fs()
        {
            ...
            if ( !isset( $wple_fs ) ) {
                ...
                $wple_fs = fs_dynamic_init( array(
                    ...
                    'is_premium'     => false,
                    'premium_suffix' => 'WP Encryption PRO',
                    'has_addons'     => false,
                    'has_paid_plans' => true,
                    'menu'           => array(
                    'slug'    => 'wp_encryption',
